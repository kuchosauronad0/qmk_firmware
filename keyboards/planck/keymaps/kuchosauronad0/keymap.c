...
////Tap once for Esc, twice for Insert
//  [TD_ESC_INS]  = ACTION_TAP_DANCE_DOUBLE(KC_ESC, KC_INS)
...
[_QWERTY] = LAYOUT_planck_grid(
   ...
   // KC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,    UC(0x62),    UC(0x6E),    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT ,
